...
/**
 * Servlet implementation class getFilmByDirectorjQuery
 */
@WebServlet("/getFilmByDirectorjQuery")
public class getFilmByDirectorjQuery extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public getFilmByDirectorjQuery() {
        super();
